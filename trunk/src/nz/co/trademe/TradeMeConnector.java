...
public class TradeMeConnector {
    ...
    public void checkAuthorisation() {
    	try {
		if (props.containsKey("access.token") && props.containsKey("access.secret")) {
			accessToken = new Token(props.getProperty("access.token"), props.getProperty("access.secret"));
    			...
    			System.out.println("This application needs authorisation first.");
